(function () {
  ...
  describe('Admin Songmaker List Controller Tests', function () {
    // Initialize global variables
    var SongmakersAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _SongmakerService_) {
      ...
      $httpBackend.whenGET('/modules/songmaker/client/views/list-songmaker.client.view.html').respond(200, '');
      ...
      SongmakersAdminListController = $controller('SongmakerAdminListController as vm', {
        $scope: $scope
      });
